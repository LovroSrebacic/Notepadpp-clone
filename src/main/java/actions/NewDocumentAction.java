...
public class NewDocumentAction extends LocalizableAction{
	...
	public NewDocumentAction(DefaultMultipleDocumentModel documents, String key, ILocalizationProvider provider, KeyStroke keyStroke, int mnemonicKey, boolean enabled) {
